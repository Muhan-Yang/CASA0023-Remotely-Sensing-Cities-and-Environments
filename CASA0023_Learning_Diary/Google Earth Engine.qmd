...
```{r echo=FALSE, out.width = "90%", fig.align='center', cache=FALSE}
knitr::include_graphics(here::here("images", "remotesensing-10-01488-g018-550.jpg"))
```

*Phoenix MA: LC situation in 1992 (**a**) and in 2011 (**b**). In red, the Urbanized class, in light green, the Cultivated class, in dark green, the Forest and Shrubland classes*
